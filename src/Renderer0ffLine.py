...
class RendererOffLine:
    ...
    def __init__(self):
        ...
        self.local_task_list = self.local_task_list_logfile
    ...
    def render_scene(self):
        ...
        for i in range(self.simulation_duration):
            ...
            local_task_list = self.local_task_list_logfile.readline()
            self.local_task_list = local_task_list.split('/')[1].split(':')
    ...
    def plot_AGVs(self):
        ...
        for i in range(len(global_robot_list) - 1):
            ...
            # Plot assigned tasks
            list_ = local_task_list[int(robot[0]) - 1].split(',')[1]
            if not list_ == "[]":
